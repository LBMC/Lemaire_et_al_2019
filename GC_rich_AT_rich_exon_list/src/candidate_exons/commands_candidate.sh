...
python3.5 src/candidate_exons/GC_candidate_exons.py -e result/GC_rich_exons -n GC -l SNRNP70 DDX5_DDX17 -s data/sed.db -f data/fasterDB_lite.db -o result/candidate/GC
python3.5 src/candidate_exons/GC_candidate_exons.py -e result/GC_rich_exons -n GC -l SNRNP70 SNRPC -s data/sed.db -f data/fasterDB_lite.db -o result/candidate/GC
