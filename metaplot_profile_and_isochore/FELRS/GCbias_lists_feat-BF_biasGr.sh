...
selrs_parts_flag='--selrs-parts --lists,--features,--base-fraction' # pourrez rajouter '--features'
# selrs_parts_flag='--selrs-parts --lists,--base-fraction' # pourrez rajouter '--features'
# selrs_parts_flag='--selrs-parts --base-fraction' # pourrez rajouter '--features'
# selrs_parts_flag='--selrs-parts --features' #,--base-fraction' # pourrez rajouter '--features'
bf_parts_flag='--bf-parts --dna-seq,--base-metaplot'
...
for nbh_sign in '' '_nbup' '_nbdown'; do #
  ...
  ${with_refs_exons_flag} --fig-prefix ${exons_list_name} ${color_pallette} ${selrs_parts_flag} ${bf_parts_flag} ${no_ref_links} ${coverage_summary_bank_sel_arg}
  "
