...
siPP_siGL2_signal_img_height = floor( 2 * img_height / 3 )
second_column_x = prs.slide_width - slide_marge_right - 2 * siPP_siGL2_signal_img_height

page_title = 'siPP-siGL2_signal'
...
RRBS_dir = fig_dir + '/RRBS/inEx%s_outOff%s/diffMethCyt/win20b' % ( inEx, outOff )
metagene_dir = '/diffCov/metagene_mean'
heatmap_dir = '/diffCov/5clusters/5mms'
...
textbox = slide.shapes.add_textbox( left=current_x + offset_x + siPP_siGL2_signal_img_height, top=current_y, width=Inches( 0.3 ), height=height_tbx )
textbox.text = '5\'SS'
textbox.text_frame.paragraphs[0].runs[0].font.size = font_size_small
...
img = slide.shapes.add_picture( image_file, left=current_x, top=current_y, height=siPP_siGL2_signal_img_height )
...
current_y = current_y + height_tbx
try:
    image_file = MNase_dir + heatmap_dir + '/heatmap_kmeansp2_siGL2n1-siDDX5-17n1_allExons_exon_up_' + exon_list_name + '_3SS.png'
    img = slide.shapes.add_picture( image_file, left=current_x, top=current_y, height=siPP_siGL2_signal_img_height )
except:
    textbox = slide.shapes.add_textbox( left=current_x, top=current_y, width=Inches( 1.55 ), height=height_tbx )
...
current_x = current_x + img.width
try:
    image_file = MNase_dir + heatmap_dir + '/heatmap_kmeansp2_siGL2n1-siDDX5-17n1_allExons_exon_up_' + exon_list_name + '_5SS.png'
    img = slide.shapes.add_picture( image_file, left=current_x, top=current_y, height=siPP_siGL2_signal_img_height )
except:
    textbox = slide.shapes.add_textbox( left=current_x, top=current_y, width=Inches( 1.55 ), height=height_tbx )
    textbox.text = 'no image'
...
current_y = current_y + height_tbx
try:
    image_file = MNase_dir + heatmap_dir + '/heatmap_kmeansp2_siGL2n1-siDDX5-17n1_allExons_exon_down_' + exon_list_name + '_3SS.png'
    img = slide.shapes.add_picture( image_file, left=current_x, top=current_y, height=siPP_siGL2_signal_img_height )
except:
    textbox = slide.shapes.add_textbox( left=current_x, top=current_y, width=Inches( 1.55 ), height=height_tbx )
    textbox.text = 'no image'
...
current_x = current_x + img.width
try:
    image_file = MNase_dir + heatmap_dir + '/heatmap_kmeansp2_siGL2n1-siDDX5-17n1_allExons_exon_down_' + exon_list_name + '_5SS.png'
    img = slide.shapes.add_picture( image_file, left=current_x, top=current_y, height=siPP_siGL2_signal_img_height )
except:
    textbox = slide.shapes.add_textbox( left=current_x, top=current_y, width=Inches( 1.55 ), height=height_tbx )
    textbox.text = 'no image'
...
current_y = current_y + height_tbx
try:
    image_file = MBD_dir + heatmap_dir + '/heatmap_kmeansp2_siGL2n2-siPPn2_allExons_exon_up_' + exon_list_name + '_3SS.png'
    img = slide.shapes.add_picture( image_file, left=current_x, top=current_y, height=siPP_siGL2_signal_img_height )
except:
    textbox = slide.shapes.add_textbox( left=current_x, top=current_y, width=Inches( 1.55 ), height=height_tbx )
    textbox.text = 'no image'
...
current_x = current_x + img.width
try:
    image_file = MBD_dir + heatmap_dir + '/heatmap_kmeansp2_siGL2n2-siPPn2_allExons_exon_up_' + exon_list_name + '_5SS.png'
    img = slide.shapes.add_picture( image_file, left=current_x, top=current_y, height=siPP_siGL2_signal_img_height )
except:
    textbox = slide.shapes.add_textbox( left=current_x, top=current_y, width=Inches( 1.55 ), height=height_tbx )
    textbox.text = 'no image'
...
current_y = current_y + height_tbx
try:
    image_file = MBD_dir + heatmap_dir + '/heatmap_kmeansp2_siGL2n2-siPPn2_allExons_exon_down_' + exon_list_name + '_3SS.png'
    img = slide.shapes.add_picture( image_file, left=current_x, top=current_y, height=siPP_siGL2_signal_img_height )
except:
    textbox = slide.shapes.add_textbox( left=current_x, top=current_y, width=Inches( 1.55 ), height=height_tbx )
    textbox.text = 'no image'
...
current_x = current_x + img.width
try:
    image_file = MBD_dir + heatmap_dir + '/heatmap_kmeansp2_siGL2n2-siPPn2_allExons_exon_down_' + exon_list_name + '_5SS.png'
    img = slide.shapes.add_picture( image_file, left=current_x, top=current_y, height=siPP_siGL2_signal_img_height )
except:
    textbox = slide.shapes.add_textbox( left=current_x, top=current_y, width=Inches( 1.55 ), height=height_tbx )
    textbox.text = 'no image'
...
#   #   #   # 3'SS
current_y = current_y + height_tbx
image_file = RRBS_dir + '/' + exon_list_name + '_3SS_]87:]_diffFract.png'
img = slide.shapes.add_picture( image_file, left=current_x, top=current_y, height=siPP_siGL2_signal_img_height )

#   #   #   # 5'SS
current_x = current_x + img.width
image_file = RRBS_dir + '/' + exon_list_name + '_5SS_]87:]_diffFract.png'
img = slide.shapes.add_picture( image_file, left=current_x, top=current_y, height=siPP_siGL2_signal_img_height )
