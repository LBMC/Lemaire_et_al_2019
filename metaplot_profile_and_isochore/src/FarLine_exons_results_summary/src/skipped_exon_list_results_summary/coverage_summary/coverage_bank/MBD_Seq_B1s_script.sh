...
expSeq_bw_files="$( echo $( find ${expSeq_bw_dir}/ -maxdepth 1 -name "MBDseq_pool1_MCF7siGL2n1_*_treat_pileup.bw" | sort ) $( find ${expSeq_bw_dir}/ -maxdepth 1 -name "MBDseq_pool1_MCF7siPPn1_*_treat_pileup.bw" | sort ) | tr ' ' ',' )"
