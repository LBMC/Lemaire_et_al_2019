...
expSeq_bw_files="$( echo $( find ${expSeq_bw_dir}/ -maxdepth 1 -name "siGL2n?_treat_pileup.bw" | sort ) $( find ${expSeq_bw_dir}/ -maxdepth 1 -name "siDDX5-17n?_treat_pileup.bw" | sort ) | tr ' ' ',' )"
