...
wdir=${HOME}/analyses_SEBASTIEN/analyse_RNA-Seq_splicingFactors_2018-07/gene_metaVisu/res #_GConlyGene
...
col_nbr=0
# target_mem=''
for target in $( echo "${signal_group_list}" | grep -vP '^(#|$)' )
do
  #H2A H3 H3K27ac H3K27me3 H3K36me3 H3K4me1 H3K4me2 H3K4me3 H3K4me3B H3K79me2 H3K79me3 H3K9ac H3K9me2 H3K9me3 H4K20me1 MNAse POLR2A POLR2AphosphoS2 POLR2AphosphoS5; do
  #RNA-Seq_SplicingLore; do 
  ...
  for marq in '_293T' '_K562' '_HepG2' ''; do #'_*' 
    echo "!!! marque: $marq"
    for signal_group in ${signal_group_list}; do #histoneAc_clineChromLore histoneMeth_complete_refined
      ...
      while read signal; do
        ...
        vt_key=${annot_type}
          ...
          cmd="find ${res_dir}*/geneVisu${marq}_${annot_type}/results/figures/coverage_summary/${visu_type[${vt_key}]}/${signal}/cov/metagene_${measure_type}/ -name \"metagene_${measure_type}*.png\"| grep -v 'res_jbc' " # | grep _${target}_ "
          echo ">>> $cmd"
          img="$( eval "$cmd" )"
          echo -e "images:\n$img"
